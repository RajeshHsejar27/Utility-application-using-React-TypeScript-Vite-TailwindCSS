...
import { Menu, X, Home, Cloud, Hash, Calculator, Calendar as CalendarIcon, Github, ExternalLink } from 'lucide-react';
...
/**
 * Layout component that provides consistent header, navigation, and footer
...
const Layout: React.FC<LayoutProps> = ({ children }) => {
  ...
  const navigation = [
    ...
    { name: 'Counter', href: '/counter', icon: Hash },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-gray-600 text-sm mb-4 md:mb-0">
              © {new Date().getFullYear()} UtilityHub. A comprehensive utility website built with React & TypeScript.
            </div>
